            ...
            <Sheet>
                ...
                <SheetContent side="left" className="border-none bg-white">
                    <Link href={"/"} className='cursor-pointer items-center gap-1 px-4 flex'>
                        <Image src='/icons/logo.svg' width={34} height={34} alt='Infinity logo' />
                                ...
                                {sidebarLinks.map((item) => {
                                    ...
                                    return (
                                        ...
                                        <Link key={item.label} href={item.route} className={cn('mobilenav-sheet_close w-full', { 'bg-bank-gradient': isActive })} >
                                                ...
                                                <Image src={item.imgURL} alt={item.label} width={20} height={20} className={cn({ 'brightness-[3] invert-0:isA': isActive })} />
